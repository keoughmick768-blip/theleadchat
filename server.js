...
function getSmartFallback(businessInfo, userMessage) {
    ...
    if (isTheLeadChat) {
        const theleadchatPatterns = [
            { keywords: ['price', 'cost', 'how much', 'charge', 'fee', 'pricing'], response: `We have two plans: Starter at $97/month (1 phone number, 100 AI responses/month, basic widget, email support) and Professional at $197/month (3 phone numbers, unlimited AI, calendar integration, priority support). Which one interests you?` },
...
- Pricing: Starter $97/mo (1 phone#, 100 AI responses), Professional $197/mo (3 phone#, unlimited AI, calendar)
